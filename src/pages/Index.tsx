...
const panettoni: Panettone[] = [
  ...
  },
  {
    ...
    imagePlaceholder: "Foto panettone cioccolato",
  },
  {
    name: "Pistacchio",
    price: "€35,00",
    ingredients: [
      ...
      "Lievito madre naturale",
      "Miele di castagno",
      "Pasta di pistacchio pura 100%",
    ],
    description: "Un'esperienza unica con il pistacchio di Bronte DOP, che regala note aromatiche inconfondibili.",
  ...
  },
  {
    ...
    description: "Fresco e profumato, con limoni di Sorrento IGP e un delicato aroma di limoncello.",
    imagePlaceholder: "Foto panettone limoncello",
  },
];
